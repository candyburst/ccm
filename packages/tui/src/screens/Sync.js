...
const TOGGLES = [
  {
    key: 'smartResume',
    label: 'Smart resume on switch',
    desc: 'Transfer JSONL + --resume when rotating accounts',
  },
  {
    key: 'gitCheckpoint',
    label: 'Git checkpoint on switch',
    desc: 'git add -A && commit before every account rotation',
  },
]
  ...
  return (
    <Box flexDirection="column" gap={1}>
      ...
      <Box flexDirection="column" borderStyle="single" borderColor="gray" paddingX={1}>
        ...
        {gitSt?.isGitRepo && (
          <Text dimColor>
            Press <Text bold>c</Text> to checkpoint now
          </Text>
        )}
      </Box>
