...
export default function Onboard({ onComplete }) {
  ...
  async function saveName() {
    ...
    if (/[^a-zA-Z0-9_-]/.test(form.name.trim()))
      return setError('Name can only contain letters, numbers, - and _')
    setError('')
  ...
  async function handleProjectChoice(shouldBind) {
    if (shouldBind) {
      try {
        ...
        /* skip — project binding is optional */
      }
    }
    setStep(STEPS.DONE)
  }
    ...
    return (
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <p style={styles.desc}>No accounts configured yet. This wizard takes about 60 seconds.</p>
          ...
          <button
            className="primary"
            style={{ marginTop: 32, width: '100%', padding: '10px 0', fontSize: 14 }}
      ...
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <div style={{ color: 'var(--text3)', fontSize: 12 }}>
            Checking with Anthropic — this takes a moment
          </div>
        </div>
      </div>
    )
        ...
        <div style={styles.card}>
          ...
          >
            ...
            {type === 'api_key' ? (
              ...
              <>
                <Code>{`ccm login ${form.name}`}</Code>
                <Code style={{ marginTop: 6 }}>ccm run</Code>
              </>
            )}
          </div>
      ...
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <p style={styles.desc}>
            ...
            <span style={{ color: 'var(--accent)', fontFamily: 'var(--font)' }}>ccm run</span> in a
            specific directory.
          </p>
          ...
          <>
            ...
            <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={styles.btnRow}>
                <button className="ghost" onClick={() => setStep(STEPS.TYPE)}>
                  ← back
                </button>
                <button className="primary" onClick={saveName} disabled={busy}>
                  Continue →
                </button>
              </div>
            </div>
        ...
        {step === STEPS.CREDENTIAL && (
          <>
            ...
            <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              {error && <ErrMsg msg={error} />}
              <div style={styles.btnRow}>
                <button className="ghost" onClick={() => setStep(STEPS.NAME)}>
                  ← back
                </button>
                <button className="primary" onClick={saveCredential} disabled={busy}>
                  Continue →
                </button>
              </div>
            </div>
        ...
        {step === STEPS.NOTES && (
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              {error && <ErrMsg msg={error} />}
              <div style={styles.btnRow}>
                <button className="ghost" onClick={() => setStep(STEPS.CREDENTIAL)}>
                  ← back
                </button>
